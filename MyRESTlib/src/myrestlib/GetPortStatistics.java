...
public class GetPortStatistics {
  public static String getstats(String port,String sw)
  {
        ...
        String myurl="http://172.16.52.140:8181/restconf/operational/opendaylight-inventory:nodes/node/"+sw+"/node-connector/"+port;
       ...
       String res= mylib.myGetRequest(myurl);
        ...
        for(int i=0;i<n;i++)
        {
            ...
            JSONObject portstats=myobj1.getJSONObject("opendaylight-port-statistics:flow-capable-node-connector-statistics");
